      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-luxury-gold to-yellow-500 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
              <Crown className="w-6 h-6 lg:w-7 lg:h-7 text-black" />
            </div>
            <span className="text-xl lg:text-2xl font-display font-bold text-luxury-gold">
              SUGGESTLY ELITE
            </span>
          </Link>
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="border-t border-luxury-gold/20 pt-4">
                <h4 className="text-luxury-gold font-semibold mb-3">Services</h4>
