# PowerShell script for Windows deployment user setup
# Run as Administrator

Write-Host "🔧 SETTING UP DEPLOYMENT USER FOR WINDOWS" -ForegroundColor Green
...
# Add deploy user to Docker Users group (if Docker Desktop is installed)
...
Write-Host "✅ DEPLOYMENT USER SETUP COMPLETE!" -ForegroundColor Green
