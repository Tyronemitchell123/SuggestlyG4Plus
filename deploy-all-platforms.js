...
if (fs.existsSync('.git')) {
    ...
    try {
        ...
        if (status.trim()) {
            ...
            console.log('   git add . && git commit -m "Ready for multi-platform deployment" && git push\n');
        } else {
...
console.log('Your SUGGESTLY ELITE will be live on 4 platforms simultaneously! 🎉');
