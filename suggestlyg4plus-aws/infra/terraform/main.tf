...
locals {
  frontend_bucket_name = var.frontend_bucket != "" ? var.frontend_bucket : "${var.project}-frontend-${var.environment}"
}
...
resource "aws_cloudfront_distribution" "frontend" {
  ...
  viewer_certificate {
    ...
    cloudfront_default_certificate = var.domain == "" ? true : null
  }
}
...
# Route53 Records (only if domain and hosted zone are provided)
resource "aws_route53_record" "main" {
  count   = var.domain != "" && var.hosted_zone_id != "" ? 1 : 0
