...
console.log('   Windows: Download from https://cloud.google.com/sdk/docs/install');
...
console.log('  --set-env-vars FIREBASE_AUTH_DOMAIN=your_firebase_auth_domain \\');
console.log('  --set-env-vars STRIPE_PUBLISHABLE_KEY=your_stripe_publishable_key \\');
...
console.log('📞 Need help? Check Google Cloud docs: https://cloud.google.com/run/docs');
