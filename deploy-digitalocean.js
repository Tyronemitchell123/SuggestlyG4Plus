...
console.log(
  "   Windows: Download from https://docs.digitalocean.com/reference/doctl/how-to/install/"
);
console.log("   macOS: brew install doctl");
console.log("   Linux: snap install doctl\n");
...
if (fs.existsSync("package.json")) {
  ...
  if (scripts.build) {
    ...
    console.log(
      "⚠️  No build script found. This is optional for static sites."
    );
  }
...
console.log("==================");
console.log(
  'git add . && git commit -m "Ready for DigitalOcean deployment" && git push'
);
